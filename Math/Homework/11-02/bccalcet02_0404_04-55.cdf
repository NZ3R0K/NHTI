...
NotebookDataLength[     38878,        893]
NotebookOptionsPosition[      6225,        135]
NotebookOutlinePosition[     39655,        905]
CellTagsIndexPosition[     39612,        902]
WindowTitle->Section 4.4, Figure 4.55
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`theta$$ = Rational[1, 3] Pi, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`theta$$], Rational[1, 3] Pi, "\[Theta]"}, 0, Pi}}, 
     Typeset`size$$ = {440., {141.34375, 146.65625}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`theta$8232$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`theta$$ = Rational[1, 3] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`theta$$, $CellContext`theta$8232$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Graphics[{
             ...
             Line[{{0, -1}, {
                Cos[3 (Pi/2) - $CellContext`theta$$], 
                Sin[3 (Pi/2) - $CellContext`theta$$]}}], 
             Circle[{0, 0}, 1, {Pi/2, 3 (Pi/2) - $CellContext`theta$$}], 
             Black, 
             ...
             Text["Start", {0, -1}, {0, 2}], 
             Text["Finish", {0, 1}, {0, -2}], 
             Text["\!\(TraditionalForm\`P\)", 1.1 {
                Cos[3 (Pi/2) - $CellContext`theta$$], 
                Sin[3 (Pi/2) - $CellContext`theta$$]}], 
             Text["Walk", {
               Cos[(3 (Pi/2) - $CellContext`theta$$ + Pi/2)/2], 
               Sin[(3 (Pi/2) - $CellContext`theta$$ + Pi/2)/2]}, {1.5, -1}], 
             Text["Swim", ({
                 Cos[3 (Pi/2) - $CellContext`theta$$], 
                 Sin[3 (Pi/2) - $CellContext`theta$$]} + {0, -1})/2, {
              1.5, 1}], 
             Text["\!\(TraditionalForm\`r = 1  mi\)", {0, (-1)/2}, {-1.5, 0}], 
             Text["\[Theta]", 0.25 {
                Cos[3 (Pi/2) - $CellContext`theta$$/2], 
                Sin[3 (Pi/2) - $CellContext`theta$$/2]}], 
             
             Circle[{0, 0}, 0.15, {
              3 (Pi/2) - $CellContext`theta$$, 3 (Pi/2)}], 
             Text["\!\(TraditionalForm\`\[Pi] - \[Theta]\)", 0.35 {
                Cos[(3 (Pi/2) - $CellContext`theta$$ + Pi/2)/2], 
                Sin[(3 (Pi/2) - $CellContext`theta$$ + Pi/2)/2]}], 
             Circle[{0, 0}, 0.2, {Pi/2, 3 (Pi/2) - $CellContext`theta$$}], 
             Black, 
             Point[{0, -1}], 
             Point[{0, 1}], $CellContext`bcR, 
             Point[{
               Cos[3 (Pi/2) - $CellContext`theta$$], 
               Sin[3 (Pi/2) - $CellContext`theta$$]}]}, 
            PlotRange -> {{-1.5, 1.5}, {-1.5, 1.5}}, 
            BaseStyle -> {"Text", 13}, ImageSize -> 4 72], 
           Plot[
           Sin[$CellContext`\[Theta]/2] + (Pi - $CellContext`\[Theta])/
             3, {$CellContext`\[Theta], 0, Pi}, 
            Ticks -> {{0, Pi/2, Pi}, None}, AxesOrigin -> {0, 0}, 
            PlotStyle -> {{Thick, Black}}, AxesLabel -> {"\[Theta]", "Time"}, 
            Epilog -> {$CellContext`bcR, 
              AbsolutePointSize[7], 
              
              Point[{$CellContext`theta$$, 
                Sin[$CellContext`theta$$/2] + (Pi - $CellContext`theta$$)/
                 3}]}, BaseStyle -> {"Text", 13}, ImageSize -> 2 72, 
            AspectRatio -> 1.5]}}, Alignment -> {Center, Center}], 
       "Specifications" :> {{{$CellContext`theta$$, Rational[1, 3] Pi, 
           "\[Theta]"}, 0, Pi, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{580., {159., 165.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({$CellContext`bcR = RGBColor[0.8, 0, 0.4], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Figure 4.55"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Figure 4.55"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4948, 102, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 8L4axUVObrmL#KOdK2IG1dFS *)
