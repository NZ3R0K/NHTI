...
NotebookDataLength[     38277,        883]
NotebookOptionsPosition[      5625,        125]
NotebookOutlinePosition[     39055,        895]
CellTagsIndexPosition[     39012,        892]
WindowTitle->Section 4.4, Figure 4.53
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 10, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"w\",\nFontSlant->\"Italic\"]\)"}, 1, 32, 0.1}}, 
     Typeset`size$$ = {404., {155.34375, 160.65625}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$8128$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 10}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$8128$$, 0]}, 
       "OtherVariables" :> {
             ...
             Text[
              Framed[
               Pane[
                ...
                Row[{"Objective function: \!\(TraditionalForm\`V = \
\*SuperscriptBox[\(w\), \(2\)] h\)", "\n", 
                  "Constraint: \!\(TraditionalForm\`2  w + h = 64\)"}], \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {0, 0, 70}, {0, 
              1}], 
             Opacity[0.7], 
             EdgeForm[Black], 
             
             Cuboid[{(-$CellContext`xValue$$)/2, (-$CellContext`xValue$$)/2, 
               0}, {$CellContext`xValue$$/2, $CellContext`xValue$$/2, 64 - 
               2 $CellContext`xValue$$}], 
             Opacity[1], 
             Text[
             "\!\(TraditionalForm\`w\)", {
              0, (-$CellContext`xValue$$)/2 - 2, 0}], 
             Text[
             "\!\(TraditionalForm\`w\)", {(-$CellContext`xValue$$)/2 - 2, 0, 
               0}], 
             Text[
             "\!\(TraditionalForm\`h\)", {$CellContext`xValue$$/2 + 
               2, (-$CellContext`xValue$$)/2 - 2, 
               32 - $CellContext`xValue$$}]}, Boxed -> False, Axes -> None, 
            ViewPoint -> {-1, -3, 2}, 
            PlotRange -> {{-16, 16}, {-16, 16}, {0, 65}}, 
            BaseStyle -> {"Text", 13}, ImageSize -> 2.5 72, AspectRatio -> 
            Automatic], 
           
           Plot[$CellContext`w^2 (64 - 2 $CellContext`w), {$CellContext`w, 0, 
             32}, PlotStyle -> {{Thick, Black}}, ImageSize -> 3 72, 
            AspectRatio -> 1, Ticks -> None, 
            PlotRange -> {{0, 34}, {0, 10000}}, 
            AxesLabel -> {"\!\(TraditionalForm\`w\)", "Volume"}, 
            BaseStyle -> {"Text", 13}, Epilog -> {$CellContext`bcR, 
              AbsolutePointSize[7], 
              
              Point[{$CellContext`xValue$$, $CellContext`xValue$$^2 (64 - 
                 2 $CellContext`xValue$$)}]}]}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Figure 4.53"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Figure 4.53"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4348, 92, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature aINxb57LTqwE0I5uS7ney9Rk *)
