...
NotebookDataLength[     38021,        878]
NotebookOptionsPosition[      5369,        120]
NotebookOutlinePosition[     38799,        890]
CellTagsIndexPosition[     38756,        887]
WindowTitle->Section 4.4, Figure 4.58
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 10, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 10, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1, 22}}, 
     Typeset`size$$ = {432., {133., 139.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$8346$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 10}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$8346$$, 0]}, 
       "OtherVariables" :> {
       ...
       Graphics[{LightBrown, 
          Rectangle[{0, 0}, {-5, 20}], Brown, 
          AbsoluteThickness[1.5], 
          Line[{{0, 0}, {0, 20}}], Black, 
          Text["House", {-2.5, 20}, {0, 1.5}], 
          AbsoluteThickness[2], 
          Text["Fence", {3, 8}, {-1.5, -1.5}], Dashed, 
          Line[{{3, 0}, {3, 8}}], 
          Dashing[{}], 
          
          Line[{{0, 8 (($CellContext`xValue$$ + 3)/$CellContext`xValue$$)}, {
            3 + $CellContext`xValue$$, 0}}], 
          Text["Ladder", {3 + $CellContext`xValue$$, 0}, {-1, -2}], 
          Text["3", {1.5, 0}, {0, 1.5}], 
          Text["8", {3, 4}, {-2, 0}], 
          Arrowheads[{-0.025, 0.025}], 
          AbsoluteThickness[0.5], 
          Arrow[{{3, -0.5}, {3 + $CellContext`xValue$$, -0.5}}], 
          Text[
          "\!\(TraditionalForm\`x\)", {3 + $CellContext`xValue$$/2, 0}, {0, 
           2}], 
          
          Arrow[{{-0.5, 0}, {-0.5, 
             8 (($CellContext`xValue$$ + 3)/$CellContext`xValue$$)}}], 
          Text[
          "\!\(TraditionalForm\`b\)", {
           0, 4 (($CellContext`xValue$$ + 3)/$CellContext`xValue$$)}, {5, 0}], 
          Inset[
           
           Plot[(($CellContext`x + 3)^2 + (
               8 (($CellContext`x + 3)/$CellContext`x))^2)^
            Rational[1, 2], {$CellContext`x, 0, 22}, ImageSize -> 2.5 72, 
            AxesOrigin -> {0, 0}, PlotStyle -> {{Thick, Black}}, 
            PlotRange -> {{0, 22}, {0, 35}}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {"\!\(TraditionalForm\`x\)", "Length"}, Ticks -> 
            None, Epilog -> {$CellContext`bcR, 
              AbsolutePointSize[6], 
              
              Point[{$CellContext`xValue$$, (($CellContext`xValue$$ + 3)^2 + (
                   8 (($CellContext`xValue$$ + 3)/$CellContext`xValue$$))^2)^
                Rational[1, 2]}]}], {Right, Top}, {Right, Top}]}, 
         PlotRange -> {{-5, 30}, {-2, 20}}, Axes -> {True, False}, 
         BaseStyle -> {"Text", 13}, Ticks -> None, ImageSize -> 6 72], 
       "Specifications" :> {{{$CellContext`xValue$$, 10, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1, 22, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{575., {151., 156.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({
       Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
        RGBColor[0.8, 0, 0.4]}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Figure 4.58"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Figure 4.58"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4092, 87, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature xKjGODvMSCjpsJ5FFV8y87X6 *)
