...
NotebookDataLength[     60098,       1289]
NotebookOptionsPosition[     27444,        531]
NotebookOutlinePosition[     60874,       1301]
CellTagsIndexPosition[     60831,       1298]
WindowTitle->Section 5.1, Figure 5.09
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`method$$ = "Left", $CellContext`nValue$$ = 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       "Left" -> Pane[
        ...
        Hold[$CellContext`nValue$$], 5, "\!\(TraditionalForm\`n\)"}, 2, 12, 
       1}}, Typeset`size$$ = {360., {114., 119.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`method$386533$$ = 
     False, $CellContext`nValue$386534$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`method$$ = "Left", $CellContext`nValue$$ = 
         5}, "ControllerVariables" :> {
         Hold[$CellContext`method$$, $CellContext`method$386533$$, False], 
         Hold[$CellContext`nValue$$, $CellContext`nValue$386534$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Module[{$CellContext`x$}, 
           $CellContext`RiemannSum[
            $CellContext`funcC5F09[$CellContext`x$], {$CellContext`x$, 1, 
             9}, $CellContext`ComputationMethod -> $CellContext`method$$, \
$CellContext`ShowPoints -> 
            True, $CellContext`Intervals -> $CellContext`nValue$$, \
$CellContext`ShowAreaValue -> False]], 
          Plot[
           $CellContext`funcC5F09[$CellContext`x], {$CellContext`x, 0, 10}, 
            ...
            Switch[$CellContext`method$$, "Left", 
             Table[
              Text[
               ...
               1 + ($CellContext`i - 1) (
                  8/$CellContext`nValue$$), -1.75}], {$CellContext`i, 
             ...
             Table[
              Text[
               ...
               1 + ($CellContext`i - 1/2) (
                  8/$CellContext`nValue$$), -1.75}], {$CellContext`i, 
               1, $CellContext`nValue$$}], "Random", 
             Text[
             "Each \!\(TraditionalForm\`\*SubsuperscriptBox[\(x\), \(k\), \(*\
\)]\) can be any point in the \!\(TraditionalForm\`k\)th subinterval.", {
              5, -1.75}]], 
            Table[
             Text[
              Subscript["\!\(TraditionalForm\`x\)", $CellContext`i], {
              1 + $CellContext`i (
                 8/$CellContext`nValue$$), -1}], {$CellContext`i, 
              1, $CellContext`nValue$$ - 1}], 
            Text[
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = a\)", {
             1, -1}, {0.75, 0}], 
            Text[
             Row[{
               Subscript["\!\(TraditionalForm\`x\)", $CellContext`nValue$$], 
...
$CellContext`bcFO], {1, 7}, {-1, 1}], "Random", 
             Text[
              Framed[
               Pane["Riemann Sum", $CellContext`bcPBS], $CellContext`bcFO], {
              1, 7}, {-1, 1}]], 
            Text["\!\(TraditionalForm\`y = f(x)\)", {10, 7}, {1, 1}]}]}, 
         AxesOrigin -> {0, 0}, PlotRange -> {{0, 10}, {-2, 7}}, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         Ticks -> {None, None}, BaseStyle -> {"Text", 13}, ImageSize -> 5 72],
        "Specifications" :> {{{$CellContext`method$$, "Left", ""}, {
         ...
         Delimiter, {{$CellContext`nValue$$, 5, "\!\(TraditionalForm\`n\)"}, 
          2, 12, 1, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{555., {131., 137.}},
...
{$CellContext`i, 1, $CellContext`intervals}]]}]], 
          ...
          1, $CellContext`funcC5F09[
            Pattern[$CellContext`x, 
             Blank[]]] := -Sin[(Pi/5) $CellContext`x] + 5, 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F09[
            Pattern[$CellContext`x, 
             Blank[]]] := -Sin[(Pi/5) $CellContext`x] + 5}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.1, Figure 5.09"], "Header"]}, {
   Cell[
    TextData["Section 5.1, Figure 5.09"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 26167, 498, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature qJ4tgTwocIs5jIOLq5W#T4V2 *)
