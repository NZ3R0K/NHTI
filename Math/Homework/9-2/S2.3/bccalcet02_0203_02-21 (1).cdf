...
NotebookDataLength[     41259,        941]
NotebookOptionsPosition[      8606,        183]
NotebookOutlinePosition[     42036,        953]
CellTagsIndexPosition[     41993,        950]
WindowTitle->Section 2.3, Figure 2.21
WindowFrame->Normal*)
...
$CellContext`choice$$ = 1, $CellContext`zoomFactor$$ = 1, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`choice$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`sin\\ x\)", {48, Automatic}, Alignment -> 
          Center], 2 -> 
        Pane["\!\(TraditionalForm\`1 - cos\\ x\)", {48, Automatic}, Alignment -> 
          Center]}}, {{
        Hold[$CellContext`boundingFunctions$$], {}, ""}, {
       2 -> "upper bound \!\(TraditionalForm\`h(x)\)", 1 -> 
        "lower bound \!\(TraditionalForm\`f(x)\)"}}, {{
        Hold[$CellContext`zoomFactor$$], 1, "zoom"}, 1, 8}}, 
     Typeset`size$$ = {360., {130.1875, 136.8125}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`choice$85831$$ = 
     False, $CellContext`boundingFunctions$85832$$ = 
     False, $CellContext`zoomFactor$85833$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`boundingFunctions$$ = {}, \
$CellContext`choice$$ = 1, $CellContext`zoomFactor$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`choice$$, $CellContext`choice$85831$$, False], 
         Hold[$CellContext`boundingFunctions$$, \
$CellContext`boundingFunctions$85832$$, False], 
         Hold[$CellContext`zoomFactor$$, $CellContext`zoomFactor$85833$$, 0]},
        "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Show[{
             If[$CellContext`choice$$ == 1, 
              Plot[{-Abs[$CellContext`x], 
                Sin[$CellContext`x], 
                
                Abs[$CellContext`x]}, {$CellContext`x, \
(-2)/$CellContext`zoomFactor$$, 2/$CellContext`zoomFactor$$}, PlotStyle -> {
                 If[
                  MemberQ[$CellContext`boundingFunctions$$, 1], {
                  Thick, $CellContext`bcR}, None], {Thick, Black}, 
                 If[
                  MemberQ[$CellContext`boundingFunctions$$, 2], {
                  Thick, $CellContext`bcB}, None]}], 
              Plot[{0, 1 - Cos[$CellContext`x], 
             ...
             Graphics[{
               If[
                ...
                MemberQ[$CellContext`boundingFunctions$$, 
                 2], {$CellContext`bcB, 
                 Text[
                 "\!\(TraditionalForm\`y = \[LeftBracketingBar]x\
\[RightBracketingBar]\)", {-0.5, 0.5}, {1.5, 1}]}, Black], 
               If[
                ...
                MemberQ[$CellContext`boundingFunctions$$, 
                 ...
                 Text[
                  ...
                  If[$CellContext`choice$$ == 1, 
                   "\!\(TraditionalForm\`y = \(-\[LeftBracketingBar]x\
\[RightBracketingBar]\)\)", "\!\(TraditionalForm\`y = 0\)"], {-0.5, -0.6}, {
                  1.5, -1}]}, Black], 
               Text[
                
                If[$CellContext`choice$$ == 1, 
                 "\!\(TraditionalForm\`y = sin(x)\)", 
                 "\!\(TraditionalForm\`y = 1 - cos(x)\)"], {1.5, 1.3}, {1, 
                1}]}]}, 
            PlotRange -> {{(-2)/$CellContext`zoomFactor$$, 
               2/$CellContext`zoomFactor$$}, \
{(-1.5)/$CellContext`zoomFactor$$, 1.5/$CellContext`zoomFactor$$}}, 
            AxesOrigin -> {0, 0}, 
            Ticks -> {{(-Pi)/2, (-Pi)/4, (-Pi)/8, (-Pi)/16, Pi/16, Pi/8, Pi/4,
                Pi/2}, {-1, -0.5, 0.5, 1}}, BaseStyle -> {"Text", 13}, 
...
\[LeftBracketingBar]x\[RightBracketingBar]\\ on\\  - \*FractionBox[\(\[Pi]\), \
\(2\)] < x < \*FractionBox[\(\[Pi]\), \(2\)]\)", 
              "\!\(TraditionalForm\`0 \[LessEqual] 1 - cos\\ x \[LessEqual] \
\[LeftBracketingBar]x\[RightBracketingBar]\\ on\\  - \*FractionBox[\(\[Pi]\), \
\(2\)] < x < \*FractionBox[\(\[Pi]\), \(2\)]\)"], {
     ...
     Initialization:>({{$CellContext`bcR = 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[
             0.85]}}; {$CellContext`functions = {{-Abs[$CellContext`x], 
              Sin[$CellContext`x], 
              Abs[$CellContext`x]}, {0, 1 - Cos[$CellContext`x], 
              Abs[$CellContext`x]}}; Null}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.3, Figure 2.21"], "Header"]}, {
   Cell[
    TextData["Section 2.3, Figure 2.21"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7329, 150, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature iLzuDxVMY52uPK#cuj3H35dG *)
