...
NotebookDataLength[     44826,       1023]
NotebookOptionsPosition[     12172,        265]
NotebookOutlinePosition[     45602,       1035]
CellTagsIndexPosition[     45559,       1032]
WindowTitle->Section 4.5, Figure 4.61
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`showError$$ = 
     False, $CellContext`xValue$$ = 1.1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`aValue$$], 1, "\!\(TraditionalForm\`a\)"}, 0.01, 
       2.5, 0.01}, {{
       ...
       Hold[
        Button[
        "\!\(TraditionalForm\`a = 0.09\)", $CellContext`aValue$$ = 0.09, 
         BaseStyle -> 11]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`a = 1\)", $CellContext`aValue$$ = 1, BaseStyle -> 
         11]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xValue$$], 1.1, "\!\(TraditionalForm\`x\)"}, 0.01, 
       2.5, 0.01}, {{
       ...
       Hold[
        ...
        "\!\(TraditionalForm\`x = 1.1\)", $CellContext`xValue$$ = 1.1, 
         BaseStyle -> 11]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`showError$$], False, "show error"}, {True, False}}, {
       Hold[
        Row[{
          Manipulate`Place[5]}]], Manipulate`Dump`ThisIsNotAControl}}, 
     Typeset`size$$ = {360., {180., 185.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`aValue$8635$$ = 0, $CellContext`xValue$8636$$ = 
     0, $CellContext`showError$8637$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`showError$$ = 
         False, $CellContext`xValue$$ = 1.1}, "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$8635$$, 0], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$8636$$, 0], 
         Hold[$CellContext`showError$$, $CellContext`showError$8637$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC4F61[$CellContext`x], {$CellContext`x, 0, 2.5}, 
           PlotStyle -> {{Thick, Black}}, Epilog -> {Black, 
             AbsolutePointSize[6], 
             Point[{$CellContext`aValue$$, 
               $CellContext`funcC4F61[$CellContext`aValue$$]}]}], 
          Plot[
          Derivative[
             1][$CellContext`funcC4F61][$CellContext`aValue$$] \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC4F61[$CellContext`aValue$$], {$CellContext`x, -0.5, 3}, 
...
$CellContext`funcC4F61[$CellContext`aValue$$]}}], Gray, 
            Dashing[{}], Thin, 
            Line[{{$CellContext`aValue$$, 0}, {$CellContext`aValue$$, 
               $CellContext`funcC4F61[$CellContext`aValue$$]}}], Black, 
            Text[
            ...
            If[$CellContext`aValue$$ == 1, 
             Text[
              ...
              Grid[{{"Linear approximation: "}, {
                "\!\(TraditionalForm\`L(x) = \*FractionBox[\(1\), \(2\)] x + \
\*FractionBox[\(1\), \(2\)]\)"}}, Alignment -> Right], {2.5, 2.5}, {1, 1}], 
             Black], 
            If[$CellContext`aValue$$ == 0.09, 
             Text[
              
              Grid[{{"Linear approximation: "}, {
                "\!\(TraditionalForm\`L(x) = \*FractionBox[\(5\), \(3\)] x + \
\*FractionBox[\(3\), \(20\)]\)"}}, Alignment -> Right], {2.5, 2.5}, {1, 1}], 
             Black], 
            Text[
            "\!\(TraditionalForm\`f(x) = \*SqrtBox[\(x\)]\)", {2.5, 1.2}, {1, 
             0}], 
            Text[
             Framed[
              Pane[
...
$CellContext`aValue$$, "."}], {
            ...
            If[$CellContext`showError$$, {Black, 
              ...
              Line[{{$CellContext`xValue$$ - 0.025, 
                 $CellContext`funcC4F61[$CellContext`xValue$$]}, \
{$CellContext`xValue$$ + 0.025, 
              ...
              Line[{{$CellContext`xValue$$ - 0.025, 
                 Derivative[
                   1][$CellContext`funcC4F61][$CellContext`aValue$$] \
($CellContext`xValue$$ - $CellContext`aValue$$) + \
$CellContext`funcC4F61[$CellContext`aValue$$]}, {$CellContext`xValue$$ + 
                 0.025, Derivative[
                   1][$CellContext`funcC4F61][$CellContext`aValue$$] \
($CellContext`xValue$$ - $CellContext`aValue$$) + \
$CellContext`funcC4F61[$CellContext`aValue$$]}}], 
...
($CellContext`xValue$$ - $CellContext`aValue$$) + \
$CellContext`funcC4F61[$CellContext`aValue$$] - \
$CellContext`funcC4F61[$CellContext`xValue$$], {3, 3}]}, {
                 "Percent error", " = ", 
...
($CellContext`xValue$$ - $CellContext`aValue$$) + \
$CellContext`funcC4F61[$CellContext`aValue$$] - \
$CellContext`funcC4F61[$CellContext`xValue$$])/$CellContext`funcC4F61[$\
CellContext`xValue$$]) 100, {3, 3}], "%"}}, Spacings -> 0, 
                Alignment -> {Right, Center, Right}], {0, 1.8}, {-1.25, 1}]}, 
             Black]}]}, PlotRange -> {{-0.5, 2.5}, {-0.5, 2.5}}, AspectRatio -> 
         1, AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, AxesStyle -> 
         Arrowheads[{0, 0.04}], Ticks -> {{0, 1, 2}, {0, 1, 2}}, 
         BaseStyle -> {"Text", 13}, ImageSize -> 5 72], 
       "Specifications" :> {{{$CellContext`aValue$$, 1, 
           "\!\(TraditionalForm\`a\)"}, 0.01, 2.5, 0.01, ControlType -> 
          Slider, ImageSize -> Small, ControlPlacement -> 
          1}, {{$CellContext`aValue$$, 1, ""}, 0.01, 2.5, 0.01, ControlType -> 
          Trigger, 
         ...
         Button[
         "\!\(TraditionalForm\`a = 1\)", $CellContext`aValue$$ = 1, BaseStyle -> 
          11], Delimiter, {{$CellContext`xValue$$, 1.1, 
           "\!\(TraditionalForm\`x\)"}, 0.01, 2.5, 0.01, ControlType -> 
          Slider, ImageSize -> Small, ControlPlacement -> 
          3}, {{$CellContext`xValue$$, 1.1, ""}, 0.01, 2.5, 0.01, ControlType -> 
          Trigger, 
          AppearanceElements -> {"StepLeftButton", "StepRightButton"}, 
          ControlPlacement -> 4}, 
         Column[{
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F61[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F61[
            Pattern[$CellContext`x, 
             Blank[]]] := Sqrt[$CellContext`x]}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.5, Figure 4.61"], "Header"]}, {
   Cell[
    TextData["Section 4.5, Figure 4.61"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 10895, 232, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature tI4hZbmp95H6MK5@qCrKSFbw *)
