...
NotebookDataLength[     42216,        962]
NotebookOptionsPosition[      9563,        204]
NotebookOutlinePosition[     42993,        974]
CellTagsIndexPosition[     42950,        971]
WindowTitle->Section 4.6, Figure 4.69
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`cValue$$ = 0.5, $CellContext`xMax$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xMin$$], 0, "\!\(TraditionalForm\`a\)"}, -1, 1.5, 
       0.1}, {{
        Hold[$CellContext`xMax$$], 5, "\!\(TraditionalForm\`b\)"}, 3, 6, 
       0.1}, {
       Hold[
        Pane[
...
0\).", {144, Automatic}, 
       ...
       Hold[
        ...
        Hold[$CellContext`cValue$$], 0.5, "\!\(TraditionalForm\`c\)"}, 0, 5, 
       0.01}, {{
       ...
       0.88 -> Pane[
        ...
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(c\), \(2\)]\)", {
          24, Automatic}, Alignment -> Center]}}}, Typeset`size$$ = {
     432., {136., 142.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xMin$8955$$ = 
     0, $CellContext`xMax$8956$$ = 0, $CellContext`cValue$8957$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`cValue$$ = 0.5, $CellContext`xMax$$ = 
         5, $CellContext`xMin$$ = 0}, "ControllerVariables" :> {
         Hold[$CellContext`xMin$$, $CellContext`xMin$8955$$, 0], 
         Hold[$CellContext`xMax$$, $CellContext`xMax$8956$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$8957$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC4F69[$CellContext`x], {$CellContext`x, -1, 6}, 
           PlotStyle -> {{
              AbsoluteThickness[1], Gray}}], 
          Plot[
           $CellContext`funcC4F69[$CellContext`x], {$CellContext`x, \
$CellContext`xMin$$, $CellContext`xMax$$}, PlotStyle -> {{Thick, Black}}], 
          Plot[
          Derivative[
             1][$CellContext`funcC4F69][$CellContext`cValue$$] \
($CellContext`x - $CellContext`cValue$$) + \
$CellContext`funcC4F69[$CellContext`cValue$$], {$CellContext`x, -1, 6}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}]}, Epilog -> {Black, 
           AbsolutePointSize[6], 
           Point[{$CellContext`xMin$$, 
             $CellContext`funcC4F69[$CellContext`xMin$$]}], 
           Point[{$CellContext`xMax$$, 
             $CellContext`funcC4F69[$CellContext`xMax$$]}], $CellContext`bcR, 
           Dashed, 
           AbsoluteThickness[1], 
           Line[{{$CellContext`cValue$$, 0}, {$CellContext`cValue$$, 
              $CellContext`funcC4F69[$CellContext`cValue$$]}}], Black, 
           Text[
            
            Row[{"\!\(TraditionalForm\`\(\(c\)\(=\)\(\\ \)\)\)", \
$CellContext`cValue$$}], {2, 8}, {-1, 1.5}], 
           Text[
            Framed[
             Pane[
             "\!\(TraditionalForm\`f' \((c)\) = 0\\ at\\ two\\ points\\ in\\ \
\(\((0, 5)\)\(.\)\)\)", {108, Automatic}, 
              BaseStyle -> {
               LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
...
\[TildeTilde] 0.88\)", {
              ...
              Background -> White], {0.88, 0}, {0, 2}], Black], 
           If[$CellContext`cValue$$ == 3.79, 
            Text[
             Framed[
              Pane[
...
\[TildeTilde] 3.79\)", {
               Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], {3.79, 0}, {0, -2}], Black]}, 
         PlotRange -> {{-1, 6}, {-9, 8}}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, AxesStyle -> 
         Arrowheads[{0, 0.03}], BaseStyle -> {"Text", 13}, Ticks -> {
           Range[-1, 6], None}, ImageSize -> 6 72], 
       "Specifications" :> {{{$CellContext`xMin$$, 0, 
           "\!\(TraditionalForm\`a\)"}, -1, 1.5, 0.1, ControlType -> None, 
          ImageSize -> 
          Small}, {{$CellContext`xMax$$, 5, "\!\(TraditionalForm\`b\)"}, 3, 6,
           0.1, ControlType -> None, ImageSize -> Small}, Delimiter, 
         Pane[
         "Find points \!\(TraditionalForm\`c\) in the interval \
\!\(TraditionalForm\`\((0, 5)\)\) at which \!\(TraditionalForm\`f' \((c)\) = \
0\).", {144, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            ...
            Left}], 
         Spacer[{0, 
          6}], {{$CellContext`cValue$$, 0.5, "\!\(TraditionalForm\`c\)"}, 0, 
          5, 0.01, ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 1}, {{$CellContext`cValue$$, 0.5, ""}, 0, 5, 
         ...
         Column[{
          ...
          0.88 -> Pane[
            "\!\(TraditionalForm\`\*SubscriptBox[\(c\), \(1\)]\)", {
             24, Automatic}, Alignment -> Center], 3.79 -> 
           Pane["\!\(TraditionalForm\`\*SubscriptBox[\(c\), \(2\)]\)", {
             24, Automatic}, Alignment -> Center]}, ControlType -> SetterBar, 
          Appearance -> "Horizontal"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{603., {154., 159.}},
     ...
     Initialization:>({{$CellContext`funcC4F69[
          ...
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F69[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^3 - 7 $CellContext`x^2 + 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.6, Figure 4.69"], "Header"]}, {
   Cell[
    TextData["Section 4.6, Figure 4.69"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8286, 171, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zLzULtXiZV9SGL#c7pah4kmi *)
