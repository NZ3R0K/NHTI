...
NotebookDataLength[     40093,        905]
NotebookOptionsPosition[      7440,        147]
NotebookOutlinePosition[     40870,        917]
CellTagsIndexPosition[     40827,        914]
WindowTitle->Section 5.2, Figure 5.28
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`selection$$ = 0, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`selection$$], 0, ""}, {
       0 -> Pane[
         "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(a\)\), \(\(\[VeryThinSpace]\)\(d\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 1 -> 
        Pane["\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(a\)\), \(\(\[VeryThinSpace]\)\(b\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 2 -> 
        Pane["\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(b\)\), \(\(\[VeryThinSpace]\)\(c\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 3 -> 
        Pane["\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(a\)\), \(\(\[VeryThinSpace]\)\(c\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 4 -> 
        Pane["\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(b\)\), \(\(\[VeryThinSpace]\)\(d\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center]}}}, 
     Typeset`size$$ = Automatic, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`selection$2304$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`selection$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`selection$$, $CellContext`selection$2304$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F28[$CellContext`x], {$CellContext`x, 
            Switch[$CellContext`selection$$, 0, -1, 1, -1, 2, 4, 3, -1, 4, 4], 
            Switch[$CellContext`selection$$, 0, 14, 1, 4, 2, 9, 3, 9, 4, 14]},
            PlotStyle -> {{Thick, Black}}, Filling -> 0, 
           FillingStyle -> {$CellContext`bcAreaNegativeColor, \
$CellContext`bcAreaPositiveColor}], 
          Plot[
           $CellContext`funcC5F28[$CellContext`x], {$CellContext`x, -1, 14}, 
           PlotStyle -> {{Thick, Black}}]}, 
         PlotRange -> {{-1, 14.5}, {-1, 1}}, AxesOrigin -> {0, 0}, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, ImageSize -> 
         6 72, BaseStyle -> {"Text", 13}, 
         Ticks -> {{{-1, 
             "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, {
            4, "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)\!\(\*\n\
StyleBox[\" \",\nFontSlant->\"Italic\"]\)"}, {
         ...
         Epilog -> {
           If[
            MemberQ[{0, 1, 3}, $CellContext`selection$$], 
            Text[12, {1.5, 0.25}, {0, 0}], Black], 
           If[
            MemberQ[{0, 2, 3, 4}, $CellContext`selection$$], 
            Text[10, {6.5, -0.25}, {0, 0}], Black], 
           If[
            MemberQ[{0, 4}, $CellContext`selection$$], 
            Text[8, {11.5, 0.25}, {0, 0}], Black]}], 
       "Specifications" :> {{{$CellContext`selection$$, 0, ""}, {
          0 -> Pane[
            "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\
\[ThinSpace]\)\(a\)\), \(\(\[VeryThinSpace]\)\(d\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 1 -> 
...
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center], 4 -> 
           Pane["\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\
\(\[ThinSpace]\)\(b\)\), \(\(\[VeryThinSpace]\)\(d\)\)]\(f(x)\)\\ d\
\[VeryThinSpace]x\)", {72, Automatic}, Alignment -> Center]}, ControlType -> 
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F28[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Exp[(-0.05) ($CellContext`x + 1)] 
           Sin[(Pi/5) ($CellContext`x + 1)], $CellContext`bcAreaNegativeColor = 
          RGBColor[0.976, 0.871, 0.812], $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F28[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Exp[(-0.05) ($CellContext`x + 1)] 
           Sin[(Pi/5) ($CellContext`x + 1)]}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.28"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.28"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6163, 114, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zI4qgJc5tt9k4JOFhAh6jN75 *)
