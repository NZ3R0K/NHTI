...
NotebookDataLength[     62771,       1330]
NotebookOptionsPosition[     30117,        572]
NotebookOutlinePosition[     63547,       1342]
CellTagsIndexPosition[     63504,       1339]
WindowTitle->Section 5.2, Figure 5.20
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`infinite$$ = 
     False, $CellContext`intervals$$ = 6, $CellContext`method$$ = 
     "Left", $CellContext`partitionType$$ = "Uniform", Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`method$$], "Left", ""}, {
       "Left" -> Pane[
         "Left Riemann Sum", {144, Automatic}, Alignment -> Center], "Right" -> 
        Pane["Right Riemann Sum", {144, Automatic}, Alignment -> Center], 
        "Midpoint" -> 
        Pane["Midpoint Riemann Sum", {144, Automatic}, Alignment -> Center], 
        "Random" -> 
        Pane["Riemann Sum", {144, Automatic}, Alignment -> Center]}}, {{
        Hold[$CellContext`intervals$$], 6, 
        "\!\(\*\nStyleBox[\"n\",\nFontSlant->\"Italic\"]\)"}, 1, 40, 1}, {{
        Hold[$CellContext`infinite$$], False, 
        "\!\(TraditionalForm\`n \[Rule] \[Infinity]\)"}, {True, False}}, {
       Hold[
        Grid[{{
           Manipulate`Place[1]}, {
           Manipulate`Place[2]}}, Alignment -> Left]], 
       Manipulate`Dump`ThisIsNotAControl}, {
       Hold["partition type"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`partitionType$$], "Uniform", ""}, {
       "Uniform" -> "regular", "Random" -> "general"}}, {
       Hold[
        Row[{
          Manipulate`Place[3]}]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Pane[
        "As the number of subintervals \!\(TraditionalForm\`n\) increases, \
the Riemann sum approaches the net area of the region between the curve \
\!\(TraditionalForm\`y = f(x)\) and the \!\(TraditionalForm\`x\)-axis on \
\!\(TraditionalForm\`\([a, b]\)\).", {180, Automatic}, 
         BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}]], Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     432., {136., 142.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`method$2189$$ = 
     False, $CellContext`intervals$2190$$ = 0, $CellContext`infinite$2191$$ = 
     False, $CellContext`partitionType$2192$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`infinite$$ = 
         False, $CellContext`intervals$$ = 6, $CellContext`method$$ = 
         "Left", $CellContext`partitionType$$ = "Uniform"}, 
       "ControllerVariables" :> {
         Hold[$CellContext`method$$, $CellContext`method$2189$$, False], 
         Hold[$CellContext`intervals$$, $CellContext`intervals$2190$$, 0], 
         Hold[$CellContext`infinite$$, $CellContext`infinite$2191$$, False], 
         Hold[$CellContext`partitionType$$, $CellContext`partitionType$2192$$,
           False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          If[$CellContext`infinite$$, 
           Plot[
            $CellContext`funcC5F20[$CellContext`x], {$CellContext`x, 0.5, 
             6.5}, PlotStyle -> {{Thick, Black}}, Filling -> 0, 
            FillingStyle -> {$CellContext`bcAreaNegativeColor, \
$CellContext`bcAreaPositiveColor}, PlotLabel -> None], 
           Module[{$CellContext`x$}, 
            $CellContext`RiemannSum[
             $CellContext`funcC5F20[$CellContext`x$], {$CellContext`x$, 0.5, 
              6.5}, $CellContext`ComputationMethod -> $CellContext`method$$, \
$CellContext`Intervals -> $CellContext`intervals$$, \
$CellContext`ShowAreaValue -> False, $CellContext`ShowPoints -> 
             True, $CellContext`AreaColor -> \
{$CellContext`bcAreaNegativeColor, $CellContext`bcAreaPositiveColor}, \
$CellContext`BorderColor -> {$CellContext`bcAreaNegativeBorderColor, \
$CellContext`bcAreaPositiveBorderColor}, $CellContext`PartitionType -> \
$CellContext`partitionType$$]]], 
          Plot[
           $CellContext`funcC5F20[$CellContext`x], {$CellContext`x, 0, 7}, 
           PlotStyle -> {{Thick, Black}}, PlotRange -> {-0.6, 1.5}], 
          Graphics[{
            Text[
             Framed[
              Pane[
               ...
               If[$CellContext`infinite$$, 
                "\!\(TraditionalForm\`n \[Rule] \(\[Infinity]\\ and\\ \
\[CapitalDelta]\[VeryThinSpace]x \[Rule] 0\)\)", 
                
                Row[{"\!\(TraditionalForm\`\(\(n\)\(=\)\(\\ \)\)\)", \
$CellContext`intervals$$, 
                  " subintervals"}]], $CellContext`bcPBS], \
$CellContext`bcFO], {0, -0.5}, {-1.1, -1}], 
            Text[
             Framed[
              Pane[
               
               If[$CellContext`infinite$$, 
                "\!\(TraditionalForm\`Net\\ area = \*SubscriptBox[\(lim\), \
\(n \[Rule] \[Infinity]\)]\(\*UnderoverscriptBox[\(\[Sum]\), \(k = 1\), \
\(n\)]\(f(\*SubsuperscriptBox[\(x\), \(k\), \(*\)])\)\\ \[CapitalDelta]\
\[VeryThinSpace]x\)\)", 
                Row[{"Net area \[TildeTilde] ", 
                  Underoverscript[
                   Style["\[Sum]", Larger], 
                   Row[{"k", "=", 1}], $CellContext`intervals$$], 
                  "\!\(TraditionalForm\`\(f(\*SubsuperscriptBox[\(x\), \(k\), \
\(*\)])\)\\ \[CapitalDelta]\[VeryThinSpace]x\)"}]], $CellContext`bcPBS], \
$CellContext`bcFO], {3.5, 1.5}, {0, 1}], 
            Text["\!\(TraditionalForm\`y = f(x)\)", {6.5, 1.5}, {1, 1}]}]}, 
         Ticks -> {{{
            0.5, "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, {
            6.5, "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}}, None},
          PlotRange -> {{0, 7}, {-0.5, 1.5}}, AxesOrigin -> {0, 0}, 
         BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.025}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, ImageSize -> 
         6 72], "Specifications" :> {{{$CellContext`method$$, "Left", ""}, {
          "Left" -> Pane[
            "Left Riemann Sum", {144, Automatic}, Alignment -> Center], 
           "Right" -> Pane[
            "Right Riemann Sum", {144, Automatic}, Alignment -> Center], 
           "Midpoint" -> 
           Pane["Midpoint Riemann Sum", {144, Automatic}, Alignment -> 
             Center], "Random" -> 
           Pane["Riemann Sum", {144, Automatic}, Alignment -> Center]}, 
          ControlType -> SetterBar, Appearance -> "Vertical"}, 
         Delimiter, {{$CellContext`intervals$$, 6, 
           "\!\(\*\nStyleBox[\"n\",\nFontSlant->\"Italic\"]\)"}, 1, 40, 1, 
          ControlType -> Slider, ImageSize -> Small, Enabled -> Dynamic[
            Not[$CellContext`infinite$$]], ControlPlacement -> 
          1}, {{$CellContext`infinite$$, False, 
           "\!\(TraditionalForm\`n \[Rule] \[Infinity]\)"}, {True, False}, 
          ControlType -> Checkbox, ControlPlacement -> 2}, 
         Grid[{{
            Manipulate`Place[1]}, {
            Manipulate`Place[2]}}, Alignment -> Left], Delimiter, 
         "partition type", {{$CellContext`partitionType$$, "Uniform", ""}, {
          "Uniform" -> "regular", "Random" -> "general"}, ControlType -> 
          SetterBar, Enabled :> Dynamic[
            Not[$CellContext`infinite$$]], ControlPlacement -> 3}, 
         Row[{
...
\!\(TraditionalForm\`\([a, b]\)\).", {180, Automatic}, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{639., {168., 174.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F20[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Cos[(Pi/5) $CellContext`x - 5.1] + 
           0.7, $CellContext`bcAreaNegativeColor = 
          RGBColor[0.976, 0.871, 0.812], $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`RiemannSum[
...
{$CellContext`i, 1, $CellContext`intervals}], "Trapezoid", 
          ...
          Options[$CellContext`RiemannSum] = {$CellContext`Intervals -> 
            ...
            "Uniform"}, $CellContext`bcAreaNegativeBorderColor = 
          RGBColor[0.796, 0, 0.42], $CellContext`bcAreaPositiveBorderColor = 
          RGBColor[0.467, 0.753, 0.651], 
          ...
          Attributes[Underoverscript] = {NHoldRest}}; {$CellContext`funcC5F20[
           
            Pattern[$CellContext`x, 
             Blank[]]] := Cos[(Pi/5) $CellContext`x - 5.1] + 0.7}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.20"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.20"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 28840, 539, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature gJzqKOUYzPZecJ#YDGqUVtUM *)
