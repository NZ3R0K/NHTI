...
public class Lab03 : MonoBehaviour
{
	...
	public bool isDrawingEllipse = true;

	Grid2D grid = new Grid2D();
	LineDraw.Arrow arrow = new LineDraw.Arrow();
	Ellipse ellipse = new Ellipse();
	Circle circle = new Circle();

	public int currentDrawingGroup = 0;
	public TMP_Text drawingGruopText;
	...
	void Update()
	{
		if (currentDrawingGroup == 0)
		{
			drawingGruopText.text = "Current Group : Default";
		...
		else if (currentDrawingGroup == 1)
		{
			drawingGruopText.text = "Current Group : Circle";

			if (isDrawingCircle)
				DrawCircle();
		}
		else if (currentDrawingGroup == 2)
		{
			drawingGruopText.text = "Current Group : Ellipse";
...
//		DrawingTools.DrawCircle(new Vector3(0, 0), 5, 32, Color.white, grid);
	}
...
//		DrawingTools.DrawEllipse(new Vector3(0, 0), new Vector3(10, 5), 32, Color.white, grid);
	}
}